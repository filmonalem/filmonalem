...
function missed(node, store, address, messages, clear) {
  ...
  (_a = misses.get(address)) == null ? void 0 : _a.push([messages, clear]);
}
...
function createName(options) {
  var _a, _b;
  if (((_a = options.parent) == null ? void 0 : _a.type) === "list")
    return useIndex;
  return options.name || `${((_b = options.props) == null ? void 0 : _b.type) || "input"}_${++nameCount}`;
}
...
function nodeInit(node, options) {
  var _a, _b;
  const hasInitialId = (_a = options.props) == null ? void 0 : _a.id;
  if (!hasInitialId)
    (_b = options.props) == null ? true : delete _b.id;
...
function createPlaceholder(options) {
  return {
    __FKP: true,
    uid: Symbol(),
    name: (options == null ? void 0 : options.name) ?? `p_${nameCount++}`,
    value: (options == null ? void 0 : options.value) ?? null,
    _value: (options == null ? void 0 : options.value) ?? null,
    type: (options == null ? void 0 : options.type) ?? "input",
    props: {},
    use: () => {
    },
    input(value) {
...
//# sourceMappingURL=chunk-GPYL4NP3.js.map
